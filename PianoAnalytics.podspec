Pod::Spec.new do |s|
    ...
    s.subspec 'iOS' do |d|
        ...
        d.platform = :ios
        d.resource = 'Sources/PianoAnalytics/Resources/*'
    end
    ...
    s.subspec 'appExtension' do |appExt|
        ...
        appExt.platform = :ios
        appExt.resource = 'Sources/PianoAnalytics/Resources/*'
    end

    s.subspec 'watchOS' do |wos|
        wos.source_files = 'Sources/**/*.swift'
        wos.platform = :watchos
        wos.resource = 'Sources/PianoAnalytics/Resources/*'
    end

    s.subspec 'tvOS' do |tvos|
        tvos.source_files = 'Sources/**/*.swift'
        tvos.platform = :tvos
        tvos.resource = 'Sources/PianoAnalytics/Resources/*'
    end
end
